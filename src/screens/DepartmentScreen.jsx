      ...
      <section className="relative z-20 w-full max-w-sm min-h-screen px-5 py-8 flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="relative">
            ...
            <div className="relative w-24 h-24 rounded-[28px] border border-white/20 bg-white/10 backdrop-blur-3xl flex items-center justify-center shadow-[0_0_80px_rgba(139,92,246,0.45)] overflow-hidden">
              ...
              <Cpu size={42} className="text-violet-300" />
            </div>
          </div>

          {/* TITLE */}
          <h1 className="mt-16 text-2xl font-black tracking-tight text-white">
            Quelle est votre{" "}
          ...
          <p className="mt-3 text-slate-300/70 text-sm leading-6">
            Choisissez votre filière afin d’accéder aux niveaux et aux quiz
            correspondants.
          </p>
        </div>
        ...
        <div className="mt-12 flex flex-col gap-5 w-full">
          ...
          <button
            ...
            className="relative overflow-hidden rounded-[34px] border border-white/15 bg-white/[0.08] backdrop-blur-3xl p-5 flex items-center justify-between shadow-[0_0_40px_rgba(139,92,246,0.18)] active:scale-[0.98] transition"
          >
            {/* glow */}
          ...
          <button
            ...
            className="relative overflow-hidden rounded-[34px] border border-white/15 bg-white/[0.08] backdrop-blur-3xl p-5 flex items-center justify-between shadow-[0_0_40px_rgba(34,211,238,0.15)] active:scale-[0.98] transition"
          >
            {/* glow */}
